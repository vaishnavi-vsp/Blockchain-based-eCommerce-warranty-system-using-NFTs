    ...
    <div>
      ...
      >
        <div className="container_modal">
          <div className="confirmation-text">Do you confirm the order ?</div>
          <div className="button-container">
            <button className="cancel-button" onClick={handleClose}>
              Cancel
            </button>
            <button className="confirmation-button" onClick={placeOrder}>
              Confirm
            </button>
          </div>
        </div>
      ...
      <Box className={classes.leftContainer}>
        <img src={product.cover} className={classes.productImage} alt="" />
        <br />
        <Button
