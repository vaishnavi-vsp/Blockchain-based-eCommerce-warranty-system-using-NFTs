...
export const ADD_PRODUCT_DETAILS_REQUEST = 'addProductDetailsRequest'
export const ADD_PRODUCT_DETAILS_SUCCESS = 'addProductDetailSuccess'
export const ADD_PRODUCT_DETAILS_FAIL = 'addProductDetailFail'